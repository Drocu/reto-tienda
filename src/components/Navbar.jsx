        ...
        <div>
            <nav className="navbar navbar-expand-lg bg-light bg-white py-3 shadow-sm">
                <div className="container">
                    <NavLink className="navbar-brand fw-bold fs-4" to="/">LA CALLECTION</NavLink>
                    ...
                    <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                        <NavLink className="nav-link" to="/products">Producto</NavLink>
                        </li>
                        <li className="nav-item">
                    ...
                    <div className="buttons">
                        <NavLink to="/login" className="btn btn-outline-dark">
                            ...
                            <i className="fa fa-user-plus me-1"></i>Registrar</NavLink>
